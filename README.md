...
Both .txt and .ply file can be loaded into [MeshLab](https://www.meshlab.net) for visualization. For the usage of MeshLab on .txt file, see issue [#8](#8) for details. The .ply file can be directed loaded into MeshLab by dragging.
